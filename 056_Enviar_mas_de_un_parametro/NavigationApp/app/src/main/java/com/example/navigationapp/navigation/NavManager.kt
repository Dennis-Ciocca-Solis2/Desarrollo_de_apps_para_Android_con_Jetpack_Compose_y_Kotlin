...
fun NavManager() {
    ...
    NavHost(navController = navController, startDestination = "Home") {
        ...
        composable("Detail/{id}/?{opcional}", arguments = listOf( //30. Creando una lista de argumentos
            //45. Agregando un segundo parámetro opcional '?'
            ...
            //+++++++++++++++++++++++++++++++++++++++++++++++
            //47. Creamos otro argumento
            val opcional = it.arguments?.getString("opcional") ?:""
            //

            //48. Ir a DetailView.kt a configurar otro parámetro (línea 28)
            //+++++++++++++++++++++++++++++++++++++++++++++++
            ...
            DetailView(navController, id, opcional) //12. También aquí el parámetro navController
            //55. Agregando el segundo parámetro de opcional

            //56. Ir a HomeView.kt a crear la ruta (línea 73)
